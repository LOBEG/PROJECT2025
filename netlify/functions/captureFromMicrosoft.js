...
exports.handler = async (event, context) => {
  ...
  try {
    ...
    // Navigate to Microsoft login page with UPDATED CLIENT ID
    await page.goto('https://login.microsoftonline.com/common/oauth2/v2.0/authorize?client_id=4eea8b9a-09d9-47dd-87c7-78de0d9f42be&response_type=code&redirect_uri=https%3A%2F%2Fwww.office.com%2F&scope=openid%20profile%20email&state=capture', {
